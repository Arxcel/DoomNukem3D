...
// //             vline(&sdl->img, x, ytop[x], cya-1, 0x111111 ,0x222222,0x111111);
// //             /* Render floor: everything below this sector's floor height. */
// //             vline(&sdl->img, x, cyb+1, ybottom[x], 255,255,255);
...
// //                 vline(&sdl->img, x, cya, cnya-1, 0, x==x1||x==x2 ? 0 : r1, 0); // Between our and their ceiling
// //                 ytop[x] = clamp(max(cya, cnya), ytop[x], H-1);   // Shrink the remaining window below these ceilings
// //                 /* If our floor is lower than their floor, render bottom wall */
// //                 vline(&sdl->img, x, cnyb+1, cyb, 0, x==x1||x==x2 ? 0 : r2, 0); // Between their and our floor
...
// //                 vline(&sdl->img, x, cya, cyb, 0, x==x1||x==x2 ? 0 : r, 0);
// //             }
// //         }
